...
#include <string>
    ...
    /**
      ...
      * 
      */
    class CorbaNameService : public RTT::Communication::INameService, public RTT::Communication::ISetupGenerator
    {
    public:
	// Ctor / Dtor
	CorbaNameService();
	...
	virtual bool RegisterTaskContextServer(std::string Name, RTT::Communication::TaskContextServerCollection& tcsCollection); // override;
    };
