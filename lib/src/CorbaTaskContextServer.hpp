...
#include <omniORB4/CORBA.h>
    ...
    /**
      ...
      * 
      */
    class CorbaTaskContextServer : public RTT::Communication::ITaskContextServer, public RTT::Communication::ISetupGenerator
    {
    public:
	// Ctor / Dtor
	...
	void SetupGenerator(); // override
    
	// Implementation of the task context server interface
	bool AttachTo(RTT::TaskContext* pTaskContext); // override;
	bool Start(bool StartThreaded = false); // override;
	bool Stop(); // override;
	bool Delete(RTT::TaskContext* pTaskContext); // override;
